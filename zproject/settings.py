...
MIDDLEWARE = [
    ...
    'core.middleware.QuotaMiddleware',
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.user_subscription_context',
            ],
        },
    },
]
...
STRIPE_PRICE_ID = os.getenv('STRIPE_PRICE_ID', '')  # Monthly subscription price ID (₹199)
